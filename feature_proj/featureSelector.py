...
class FeatureSelector():
    ...
    def identify_low_importance(self, cumulative_importance):
        ...
        if self.feature_importances is None:
            raise NotImplementedError("""Feature importances have not yet been determined. Call the `identify_zero_importance` method first.""")
    ...
    def plot_collinear(self, plot_all = False):
        ...
        sns.heatmap(corr_matrix_plot, cmap=cmap, center=0,linewidths=.25, cbar_kws={"shrink": 0.6},annot=True)
